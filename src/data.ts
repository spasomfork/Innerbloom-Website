...
export const SITE_INFO = {
  ...
  phone: '113 334 433 221',
  phoneSecondary: '+1-410-555-0134',
  phoneContact: '+1 234 567 8902',
  email: 'info@example.com',
  emailContact: 'contact@yoursite.com',
  address: '123 Fifth Avenue, New York – 10160, USA',
  addressAlt: '123, Any Street North Your City Name Country Name, P.O 3554',
...
export const SERVICES_PAGE_CARDS: ServiceCardItem[] = [
  {
    ...
    description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi volutpat justo sed efficitur cursus. Mauris fringilla quam vitae lacinia.',
